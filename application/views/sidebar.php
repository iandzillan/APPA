<!-- Sidebar -->
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo site_url('Home') ?>">
        ...
        <div class="sidebar-brand-text mx-3">ADMIN APPA</div>
      </a>
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('Home') ?>" class="<?php if($aktif == 'home'){echo " active";} ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('Pengaduan') ?>" class="<?php if($aktif == 'pengaduan' || $aktif == 'data'){echo " active";} ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('Penduduk') ?>" class="<?php if($aktif == 'penduduk'){echo " active";} ?>">
      ...
      <!-- Nav Item - Utilities Collapse Menu -->
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('Admin') ?>" class="<?php if($aktif == 'admin'){echo " active";} ?>">
          <i class="fas fa-fw fa-folder"></i>
      ...
      <li class="nav-item">
        ...
        ?>
        <a class="nav-link" href="<?php echo site_url('Profil/profil_admin/'.$user['id_admin']) ?>" class="<?php if($aktif == 'profil'){echo " active";} ?>">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?php echo site_url('Profil/edit_akun_admin/'.$user['id_admin']) ?>" class="<?php if($aktif == 'akun'){echo " active";} ?>">
