							...
							<div class="col-lg">
								<div class="p-5">
									<div class="text-center">
										<h1 class="h2 text-center push-top-bottom animation-slideDown" style="color: black">Selamat Datang di Aplikasi Pengaduan Perempuan dan Anak</h1><br><br>
										<?php 
										...
										?>
										<form id="form-login" action="<?php echo site_url('login/proses_user') ?>" method="post" class="user">
											...
											<div class="text-center">
												<a class="small" href="<?php echo site_url('login/register'); ?>">Buat Akun Baru</a>
											</div>
										</form>
									</div>
								</div>
